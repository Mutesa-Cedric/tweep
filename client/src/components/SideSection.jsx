...
const SideSection = (props) => {
    ...
    return (
        <div className={props.fixLinks ? "sticky top-20" : ""}>
            <div id="expCategory" className={"bg-white  w-[304px] rounded-lg h-[220px] shadow-sm flex text-[#828282] flex-col justify-evenly px-1 dark:bg-inherit dark:text-gray-300"}>
