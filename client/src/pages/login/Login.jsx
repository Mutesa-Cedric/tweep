                ...
                <div className="w-full flex flex-col justify-center items-center">
                    ...
                    </div>
                    {
                        ...
                        <div className="w-full flex justify-center items-center">
                            {<p className='text-orange-500 py-2 font-semibold'>{error === "ERR_NETWORK" ? "Connection error! Check your Internet" : "Invalid Email or password!"}</p>}
                        </div>
                    }
                    {loading ?
                        <button disabled type="button" className="text-white bg-[#2F80ED] font-medium rounded-lg px-5 py-2.5 text-center mr-2 cursor-not-allowed  inline-flex items-center justify-center w-full my-3">
